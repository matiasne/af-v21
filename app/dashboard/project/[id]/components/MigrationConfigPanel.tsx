              ...
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <Select
                    ...
                    size="sm"
                    onChange={(e) => {
                      const value = e.target.value as AgentProvider | "default";
                  ...
                  {stepAgent?.provider === "openrouter" && (
                    <Select
                      ...
                      isDisabled={disabled || isLoading}
                      label="Model"
                      selectedKeys={stepAgent.model ? [stepAgent.model] : []}
                      size="sm"
                      onChange={(e) =>
                        handleStepAgentChange(
                          step,
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <p>
                  Are you sure you want to delete this code analysis? This
