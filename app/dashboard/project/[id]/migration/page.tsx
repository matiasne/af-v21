...
export default function MigrationPage() {
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 pb-24">
      ...
      {/* Error Alert */}
      {migrationError && (
        <div className="mb-6 p-4 rounded-xl bg-amber-50 dark:bg-zinc-800/80 border border-amber-200 dark:border-zinc-700">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-amber-700 dark:text-zinc-400">{migrationError}</p>
          </div>
        </div>
      )}
