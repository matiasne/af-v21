...
export interface ProjectRepository {
  ...
  startCodeAnalysis(projectId: string, migrationId: string): Promise<void>;

  stopCodeAnalysis(projectId: string, migrationId: string): Promise<void>;

  resumeCodeAnalysis(projectId: string, migrationId: string): Promise<void>;
